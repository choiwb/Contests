...
with tf.device('/cpu:0'):
    ...
    WAVELET_TRAIN_CATS_DIR = 'input/train/wavelet/cats/'
    WAVELET_TRAIN_DOGS_DIR = 'input/train/wavelet/dogs/'
    WAVELET_VALD_CATS_DIR = 'input/validation/wavelet/cats/'
    WAVELET_VALD_DOGS_DIR = 'input/validation/wavelet/dogs/'
    ...
    train_dogs = [WAVELET_TRAIN_DOGS_DIR + i for i in os.listdir(WAVELET_TRAIN_DOGS_DIR)]
    train_cats = [WAVELET_TRAIN_CATS_DIR + i for i in os.listdir(WAVELET_TRAIN_CATS_DIR)]
    vald_dogs = [WAVELET_VALD_DOGS_DIR + i for i in os.listdir(WAVELET_VALD_DOGS_DIR)]
    vald_cats = [WAVELET_VALD_CATS_DIR + i for i in os.listdir(WAVELET_VALD_CATS_DIR)]
