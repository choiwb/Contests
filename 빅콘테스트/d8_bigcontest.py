...
def get_audience(boxoffice_df):
    final_audience_df = pd.DataFrame(columns=["movieCd","preview_audience",
                                        ...
                                        "d1_seat","d2_seat","d3_seat","d4_seat","d5_seat","d6_seat","d7_seat","d8_seat",
                                        "audience"])
...
boxoffice_df = pd.read_csv("data/boxoffice.csv", index_col=0)
final_audience_df.to_csv("final_audience_d8.csv",encoding="utf-8")
...
total_movie_df.to_csv("total_movie_d8.csv",encoding="utf-8")
...
naver_df = pd.read_csv("data/total_movie_d8.csv", index_col=0)
...
url_df.to_csv("url_d8.csv",encoding="utf-8")
#url_df = pd.read_csv("data/url_d8.csv",index_col=0)
print(url_df.head())
...
star_score_df.to_csv("star_score_d8.csv",encoding="utf-8")
